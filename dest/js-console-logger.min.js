/** JSConsoleLogger v1.0.2 | Released under the MIT license | https://github.com/Kyo-suke/JSConsoleLogger */
...
(function(b){var d=function(){function a(){throw Error("Downloader is static class.");}a.download=function(c,a){var e=this;if(c=c.entity)if(a=this._genFilename(a),navigator.msSaveBlob)navigator.msSaveBlob(c,a);else{var b=null;try{var d=this._createLinkElement();b=URL.createObjectURL(c);this._setAttributes(d,a,b);d.click();setTimeout(function(){e._revoke(b)},this.REVOKE_TIMEOUT)}catch(f){console.error("failed to download."),console.error(f.meesage),console.error(f.stack),this._removeLinkElement(),
b&&this._revoke(b)}}};a._revoke=function(c){URL.revokeObjectURL(c);this._removeLinkElement()};a._genFilename=function(c){c||(c=this.DEFAULT_FILENAME);var a=new Date,b=[a.getFullYear(),a.getMonth(),a.getDate()].join("");c=c.replace("%d",b);a=[a.getHours(),a.getMinutes(),a.getSeconds()].join("");return c=c.replace("%t",a)};a._createLinkElement=function(){document.querySelector("#"+this.ELEMENT_ID)&&this._removeLinkElement();var c=document.createElement("a");c.setAttribute("id",this.ELEMENT_ID);c.setAttribute("download",
...
(function(b){var d=function(){function a(){throw Error("LogFormatter is static class.");}a.format=function(a){var c=this._getLogTypeStr(a.type),b=this._getDataStr(a.time),d=this._getTimeStr(a.time);return[b,d,c,a.message||""].join(this.DELIMITER)};a._getLogTypeStr=function(a){return"["+a+"]"};a._getDataStr=function(a){var c="";try{var b=this._paddingStr(a.getFullYear(),"0",4),d=this._paddingStr(a.getMonth()+1,"0",2),h=this._paddingStr(a.getDate(),"0",2);c=[b,d,h].join("/")}catch(f){c="--/--/--"}return c};
a._getTimeStr=function(a){var c="";try{var b=this._paddingStr(a.getHours(),"0",2),d=this._paddingStr(a.getMinutes(),"0",2),h=this._paddingStr(a.getSeconds(),"0",2),f=this._getTimezoneStr(a);c=[b,d,h].join(":");c+=" "+f}catch(l){c="??:??:?? +0000"}return c};a._getTimezoneStr=function(a){var c=Math.abs(100*a.getTimezoneOffset()/60);return(0<a.getTimezoneOffset()?"-":"+")+this._paddingStr(c,"0",4)};a._paddingStr=function(a,b,d){var c="";try{c=(Array(d+1).join(b.slice(0,1))+a).slice(-1*d)}catch(h){c=
""+a}return c};a.DELIMITER=" ";return a}();b.LogFormatter=d})(JSConsoleLogger||(JSConsoleLogger={}));
