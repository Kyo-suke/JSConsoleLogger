...
(function(b){var d=function(){function a(){throw Error("Downloader is static class.");}a.download=function(c,a){var b=this;if(c=c.entity)if(a=this._genFilename(a),navigator.msSaveBlob)navigator.msSaveBlob(c,a);else{var e=null;try{var d=this._createLinkElement();e=URL.createObjectURL(c);this._setAttributes(d,a,e);d.click();setTimeout(function(){b._revoke(e)},this.REVOKE_TIMEOUT)}catch(g){console.error("failed to download."),console.error(g.meesage),console.error(g.stack),this._removeLinkElement(),
...
(function(b){var d=function(){function a(){throw Error("LogFormatter is static class.");}a.format=function(a){var c=this._getLogTypeStr(a.type),b=this._getDataStr(a.time),d=this._getTimeStr(a.time);return[b,d,c,a.message||""].join(this.DELIMITER)};a._getLogTypeStr=function(a){return"["+a+"]"};a._getDataStr=function(a){var c="";try{var b=this._paddingStr(a.getFullYear(),"0",4),d=this._paddingStr(a.getMonth(),"0",2),h=this._paddingStr(a.getDate(),"0",2);c=[b,d,h].join("/")}catch(g){c="--/--/--"}return c};
a._getTimeStr=function(a){var c="";try{var b=this._paddingStr(a.getHours(),"0",2),d=this._paddingStr(a.getMinutes(),"0",2),h=this._paddingStr(a.getSeconds(),"0",2);c=[b,d,h].join(":")}catch(g){c="??:??:??"}return c};a._paddingStr=function(a,b,d){var c="";try{c=(Array(d+1).join(b.slice(0,1))+a).slice(-1*d)}catch(h){c=""+a}return c};a.DELIMITER=" ";return a}();b.LogFormatter=d})(JSConsoleLogger||(JSConsoleLogger={}));
(function(b){var d=function(){function a(c,b,d,f){void 0===b&&(b="text/plain");void 0===d&&(d=!1);void 0===f&&(f="crlf");this._mimeType=b;this._lineFeedCodeType=f;this._withBOM=d;c=this._logData2StrList(c);this._withBOM&&c.unshift(a.BOM);this._entity=new Blob(c,{type:this._mimeType})}a.prototype._logData2StrList=function(a){for(var c=[],d=0;d<a.length;d++){var f=b.LogFormatter.format(a[d]);f+="\n";f=this._replaceLineFeedCode(f);c.push(f)}return c};a.prototype._replaceLineFeedCode=function(a){switch(this._lineFeedCodeType){case "lf":a=
